...
class Constants:
    ...
    # 1. Fondamental constants
    pi: dtype = field(default=2*np.arcsin(1.))
    ...
    estt: dtype = field(default=611.24)     # Saturation vapor pressure at triple point temperature
    ...
    alpi: dtype  = field(init=False)        # Constants for saturation vapor pressure function over solid ice
    ...
    alphaoc: dtype = field(default=1.9e-4)     # Thermal expansion coefficient for ocean (K-1)
